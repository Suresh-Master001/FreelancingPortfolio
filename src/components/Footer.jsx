...
const socials = [
  { icon: <GitHubIcon />, label: 'GitHub', href: 'https://github.com/Suresh-Master001' },
  { icon: <LinkedInIcon />, label: 'LinkedIn', href: 'https://www.linkedin.com/in/suresh-sundharrajan' },
  { icon: <WhatsAppIcon />, label: 'WhatsApp', href: 'https://wa.me/916379080247' },
  { icon: <Mail size={20} aria-hidden="true" />, label: 'Email', href: 'mailto:suresh2309@proton.me' },
];
...
/**
 * Footer — Redesigned glass morphism layout with organized sections.
 */
export default function Footer({ footer: footerProp }) {
  ...
  return (
    <footer className="footer-new">
      ...
      <div className="footer-glass-header">
        <div className="section-container">
          <div className="footer-cta-row">
            <div className="footer-cta-text">
              <h3 className="footer-cta-title">Ready to build something great?</h3>
              <p className="footer-cta-subtitle">Let's turn your ideas into reality.</p>
            </div>
      ...
      <div className="section-container footer-body">
        <div className="grid md:grid-cols-12 gap-8 mb-10">
          ...
          <div className="md:col-span-4 footer-brand">
            ...
            {/* Social icons */}
            <div className="footer-socials" role="list" aria-label="Social links">
              {socials.map(s => (
                <a
                  key={s.label}
                  href={s.href}
          ...
          <div className="md:col-span-4">
            <div className="footer-card">
              <h4 className="footer-card-title">What I Do</h4>
              <ul className="footer-list" role="list">
                ...
                <li className="footer-list-item">
                  <span className="footer-list-bullet" aria-hidden="true">▸</span>
                  <span>Full-Stack MERN Applications</span>
                </li>
                <li className="footer-list-item">
                  <span className="footer-list-bullet" aria-hidden="true">▸</span>
                ...
                <li className="footer-list-item">
                  <span className="footer-list-bullet" aria-hidden="true">▸</span>
                  <span>SaaS MVP Build & Scaling</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="md:col-span-4">
            {footerLinks.map(group => (
              <div key={group.group} className="footer-card">
                <h4 className="footer-card-title">{group.group}</h4>
                <ul className="footer-list" role="list">
                  {group.links.map(link => (
                    <li key={link.label} role="listitem" className="footer-list-item">
                      <a
                        href={link.href}
